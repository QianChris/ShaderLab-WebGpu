// OrbitCameraController for demo6_3dgsViewer
...
export function init(ctx) {
    ...
    ctx.on('mousedown', (e) => { dragButton = e.button; prevX = e.x; prevY = e.y; });
    ctx.on('mouseup', () => { dragButton = -1; });
    ctx.on('mousemove', (e) => {
...
export function update(_ctx) {
    ...
    const ha = azimuth * 0.5, he = elevation * 0.5;
